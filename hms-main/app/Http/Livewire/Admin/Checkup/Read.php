...
class Read extends Component
{
    ...
    public function checkupDeleted(){
        // Nothing ..
    }
    ...
    public function render()
    {
        ...
        if(config('easy_panel.crud.checkup.search')){
            $array = (array) config('easy_panel.crud.checkup.search');
        ...
        return view('livewire.admin.checkup.read', [
            'checkups' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Checkup')) ]);
    }
}
