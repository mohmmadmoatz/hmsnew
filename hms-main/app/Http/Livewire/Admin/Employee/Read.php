...
class Read extends Component
{
    ...
    protected $listeners = ['employeeDeleted'];
    ...
    public function render()
    {
        ...
        if(config('easy_panel.crud.employee.search')){
            $array = (array) config('easy_panel.crud.employee.search');
        ...
        return view('livewire.admin.employee.read', [
            'employees' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Employee')) ]);
    }
}
