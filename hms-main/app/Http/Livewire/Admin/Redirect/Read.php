...
class Read extends Component
{
    ...
    protected $listeners = ['redirectDeleted'];

    public $sortType;
    public $sortColumn;

    public function redirectDeleted(){
        // Nothing ..
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.redirect.read', [
            'redirects' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Redirect')) ]);
    }
}
