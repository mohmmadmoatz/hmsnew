<div class="card">
    <div class="card-header p-0">
        <h3 class="card-title">{{ __('CreateTitle', ['name' => __('Opostpond') ]) }}</h3>
        <div class="px-2 mt-4">
    ...
    <form class="form-horizontal" wire:submit.prevent="create" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class='form-group'>
                ...
                <input readonly type='number' wire:model.lazy='operationhold_id' class="form-control @error('operationhold_id') is-invalid @enderror" id='inputoperationhold_id'>
