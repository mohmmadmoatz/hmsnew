            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style='cursor: pointer' wire:click="sort('by_user_id')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'by_user_id') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'by_user_id') fa-sort-amount-up ml-2 @endif'></i> بواسطة المستخدم </td>
