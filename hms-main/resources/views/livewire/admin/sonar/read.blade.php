    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header p-0">
                <h3 class="card-title">قسم السونار</h3>

                <div class="px-2 mt-4">

                    <ul class="breadcrumb mt-3 py-3 px-4 rounded" style="background-color: #e9ecef!important;">
                        <li class="breadcrumb-item"><a href="@route(getRouteName().'.home')" class="text-decoration-none">{{ __('Dashboard') }}</a></li>
                        <li class="breadcrumb-item active">قسم السونار</li>
                    </ul>
                    ...
                    <div class="row justify-content-between mt-4 mb-4">
                        ...
                        <div class="col-md-4 right-0">
                            <a href="@route(getRouteName().'.sonar.create')" class="btn btn-success">جديد</a>
                        </div>
                        @endif
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                    ...
                    @foreach($sonars as $sonar)
                        @livewire('admin.sonar.single', ['sonar' => $sonar], key($sonar->id))
                    @endforeach
                    </tbody>
                </table>
            </div>
            <div class="m-auto pt-3 pr-3">
                {{ $sonars->appends(request()->query())->links() }}
            </div>
