        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <!-- Date of Birth Input -->
                    <div class='form-group'>
                        <label for='inputdob' class='control-label'> {{ __('تاريخ الميلاد') }}</label>
                        <input @if($patient_id) readonly @endif type='date' wire:model.lazy='dob'
                            class="form-control @error('dob') is-invalid @enderror" id='inputdob'>
