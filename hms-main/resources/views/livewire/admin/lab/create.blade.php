<div class="card">
    ...
    <form class="form-horizontal" wire:submit.prevent="create" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class='form-group'>
                <label for='inputreference' class='col-sm-2 control-label'>reference - الطبيب</label>
                <input type="text" class="form-control" id="inputreference" wire:model.lazy='reference' list="doctors-list" autocomplete="off">
