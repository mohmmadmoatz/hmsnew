<div class="card">
    <div class="card-header p-0">
        <h3 class="card-title">{{ __('UpdateTitle', ['name' => __('Redirect') ]) }}</h3>
        <div class="px-2 mt-4">
    ...
    <form class="form-horizontal" wire:submit.prevent="update" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class='form-group'>
                <label for='inputpat_id' class='col-sm-2 control-label'> {{ __('Pat_id') }}</label>
                <input type='number' wire:model.lazy='pat_id' class="form-control @error('pat_id') is-invalid @enderror" id='inputpat_id'>
