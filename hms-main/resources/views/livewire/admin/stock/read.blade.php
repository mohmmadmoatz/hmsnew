            ...
            <div class="card-header p-0">
                ...
                <div class="px-2 mt-4">
                    ...
                    <ul class="breadcrumb mt-3 py-3 px-4 rounded" style="background-color: #e9ecef!important;">
                        ...
                        <li class="breadcrumb-item active">ادارة المخزن</li>
                    </ul>

                    <div class="row justify-content-between mt-4 mb-4">
                        @if(config('easy_panel.crud.stock.create'))
                        <div class="col-md-4 right-0">
                            <a href="@route(getRouteName().'.stock.create')" class="btn btn-success">اضافة مادة</a>
                        </div>
                        @endif
                        @if(config('easy_panel.crud.stock.search'))
                        <div class="col-md-4">
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style='cursor: pointer' wire:click="sort('qty')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'qty') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'qty') fa-sort-amount-up ml-2 @endif'></i> الكمية الحالية </td>
                        ...
                        @if(config('easy_panel.crud.stock.delete') or config('easy_panel.crud.stock.update'))
                        <td>{{ __('Action') }}</td>
                        @endif
                    </tr>

                    @foreach($stocks as $stock)
                        @livewire('admin.stock.single', ['stock' => $stock], key($stock->id))
                    @endforeach
                    </tbody>
                </table>
            </div>
