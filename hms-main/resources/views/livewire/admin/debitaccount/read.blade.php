            ...
            <div class="card-header p-0">
                ...
                <div class="px-2 mt-4">
                    ...
                    <ul class="breadcrumb mt-3 py-3 px-4 rounded" style="background-color: #e9ecef!important;">
                        ...
                        <li class="breadcrumb-item active">نظام الديون المتغيره - الحسابات</li>
                    </ul>

                    <div class="row justify-content-between mt-4 mb-4">
                        @if(config('easy_panel.crud.debitaccount.create'))
                        <div class="col-md-4 right-0">
                            <a href="@route(getRouteName().'.debitaccount.create')" class="btn btn-success">انشاء</a>
                        </div>
                        @endif
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                    ...
                    @foreach($debitaccounts as $debitaccount)
                        @livewire('admin.debitaccount.single', ['debitaccount' => $debitaccount], key($debitaccount->id))
                    @endforeach
                    </tbody>
                </table>
            </div>
            <div class="m-auto pt-3 pr-3">
                {{ $debitaccounts->appends(request()->query())->links() }}
            </div>
