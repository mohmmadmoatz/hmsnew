        ...
        <div class="card">
            <div class="card-header p-0">
                ...
                <div class="px-2 mt-4">
                    ...
                    <ul class="breadcrumb mt-3 py-3 px-4 rounded" style="background-color: #e9ecef!important;">
                        ...
                        <li class="breadcrumb-item active">{{ __(\Illuminate\Support\Str::plural('Rays')) }}</li>
                    </ul>
                    ...
                    <div class="row justify-content-between mt-4 mb-4">
                        @if(config('easy_panel.crud.rays.create'))
                        <div class="col-md-4 right-0">
                            <a href="@route(getRouteName().'.rays.create')" class="btn btn-success">جديد</a>
                        </div>
                        @endif
                        @if(config('easy_panel.crud.rays.search'))
                        <div class="col-md-4">
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                    ...
                    @foreach($rayss as $rays)
                        @livewire('admin.rays.single', ['rays' => $rays], key($rays->id))
                    @endforeach
                    </tbody>
                </table>
            </div>
            <div class="m-auto pt-3 pr-3">
                {{ $rayss->appends(request()->query())->links() }}
            </div>
